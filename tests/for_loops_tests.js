...
describe("returnEvenOddMessages", function() {
    it("should be defined", function() {
    ...
    it("should return a string when passed an integer", function() {
        ...
        expect(typeof returnEvenOddMessages(8)).toEqual('string');
    });
    it("should return the correct message when passed an integer", function() {
        ...
        expect(returnEvenOddMessages(11)).toEqual('11 is Odd')
        expect(returnEvenOddMessages(12)).toEqual('12 is Even')
        expect(returnEvenOddMessages(13)).toEqual('13 is Odd')
    });
});
